...
It's common to require a few ignore-filters to disgard any messages generated by the desktop notification system
...
The config files are in INI-format divided into a number of sections as outlined below:
        ...
        # A filter id that ends in _regexp is treatred as a python regular-expression
